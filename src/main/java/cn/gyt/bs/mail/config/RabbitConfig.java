...
public class RabbitConfig {
    ...
    public static final String MAIL_QUEUE_NAME = "book.queue";
    public static final String MAIL_EXCHANGE_NAME = "book.exchange";
    public static final String MAIL_ROUTING_KEY_NAME = "book.routing.key";
